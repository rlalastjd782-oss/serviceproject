...
class UiNavigationFlowTest(FlowTestBase):
    ...
    def test_fold_ui_regression_markers_render(self) -> None:
        ...
        self.assertIn("meal-input-row", meal_html)
        self.assertIn('name="meal_type"', meal_html)
        self.assertIn('aria-label="끼니 선택"', meal_html)
        self.assertIn('data-meal-primary-food-input', meal_html)
        self.assertIn('placeholder="음식 이름"', meal_html)
        self.assertIn('name="meal_input_basis"', meal_html)
        self.assertIn('aria-label="입력 기준"', meal_html)
        ...
        self.assertIn("음식 빌더", meal_html)
        self.assertIn("data-meal-count-input", meal_html)
        ...
        self.assertLess(meal_html.index("meal-input-row"), meal_html.index("data-food-quick-panel"))
        self.assertLess(meal_html.index("data-food-quick-panel"), meal_html.index("meal-builder-header"))
        self.assertLess(meal_html.index("meal-builder-header"), meal_html.index("식단 저장"))
        self.assertLess(meal_html.index("meal-input-row"), meal_html.index("fuel-coach-card"))
        ...
        self.assertIn("syncMealPrimaryFoodInput", meal_entry_source)
        self.assertIn("cloneFirstMealToRows", meal_entry_source)
